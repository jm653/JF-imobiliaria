...
const itensMenu = [
  ...
  { icone: Sparkles, label: "Descoberta Inteligente", href: "/area/descoberta" },
  { icone: Users, label: "Clientes", href: "/area/clientes" },
  { icone: Building2, label: "Imóveis", href: "/area/imoveis" },
  { icone: MessageCircle, label: "Conversas", href: "/area/conversas" },
  { icone: Calendar, label: "Agenda", href: "/area/agenda" },
  ...
  return (
    <div className="jf-page flex min-h-screen text-white">
      <aside className="fixed inset-y-0 left-0 z-40 hidden w-64 border-r border-white/10 bg-[#050505]/88 backdrop-blur-xl lg:block">
        ...
        <nav className="mt-4 max-h-[calc(100vh-9rem)] space-y-1 overflow-y-auto px-3">
