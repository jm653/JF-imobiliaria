export default function LoadingAreaCorretor() {
  return (
    <div
      aria-busy="true"
    ...
    >
      ...
      <main className="mx-auto max-w-6xl px-5 py-8">
        <div className="grid gap-4 xl:grid-cols-[1fr_22rem]">
          <section className="h-48 rounded-lg border border-[#DAA520]/20 bg-[#DAA520]/10 p-6" />
          <aside className="h-48 rounded-lg border border-white/10 bg-white/3 p-5" />
        </div>
